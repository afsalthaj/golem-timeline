            ...
            match result0 {
              Ok(e) => { {
                *((ptr1 + 0) as *mut u8) = (0i32) as u8;
                ...
                let vec6 = results2;
                let len6 = vec6.len() as i32;
                let layout6 = alloc::Layout::from_size_align_unchecked(vec6.len() * 32, 8);
