    ...
    pub mod event_processor {
      ...
      pub mod api {
        ...
        const _: () = {
          ...
          #[allow(non_snake_case)]
          unsafe extern "C" fn __export_initialize_tl_has_existed(arg0: i32,arg1: i32,arg2: i32,arg3: i32,arg4: i32,arg5: i64,arg6: i32,arg7: i32,) -> i32 {
            #[allow(unused_imports)]
            use wit_bindgen::rt::{alloc, vec::Vec, string::String};
            ...
            let result4 = <_GuestImpl as Guest>::initialize_tl_has_existed(WorkerId{
              name: wit_bindgen::rt::string_lift(bytes0),
            }, EventPredicate{
        ...
        pub trait Guest {
          ...
          fn initialize_tl_has_existed(worker: WorkerId,event_predicate: EventPredicate,) -> Result<wit_bindgen::rt::string::String,wit_bindgen::rt::string::String>;
