                    ...
                    pub mod timeline {
                      ...
                      pub mod core_stub {
                        ...
                        pub mod stub_core {
                          ...
                          impl Api {
                            #[allow(unused_unsafe, clippy::all)]
                            pub fn initialize_timeline(&self,timeline: &TimelineOp,) -> Result<wit_bindgen::rt::string::String,wit_bindgen::rt::string::String>{
                                    ...
                                    match e {
                                      V41::TimelineComparison(e) => {
                                        ...
                                        *((base + 12) as *mut i32) = wit_bindgen::rt::as_i32(timeline1);
                                        ...
                                        let super::super::super::timeline::core::api::Server{ worker_id:worker_id4, template_id:template_id4, } = server1;
                                        let vec5 = worker_id4;
                                        let ptr5 = vec5.as_ptr() as i32;
                                        let len5 = vec5.len() as i32;
                                        *((base + 36) as *mut i32) = len5;
                                      ...
                                      V41::TimelineNegation(e) => {
                                        ...
                                        *((base + 8) as *mut i32) = wit_bindgen::rt::as_i32(timeline7);
                                        let super::super::super::timeline::core::api::Server{ worker_id:worker_id8, template_id:template_id8, } = server7;
                                        let vec9 = worker_id8;
                                        let ptr9 = vec9.as_ptr() as i32;
                                        let len9 = vec9.len() as i32;
                                        *((base + 16) as *mut i32) = len9;
                                      ...
                                      V41::TlLatestEventToState(e) => {
                                        *((base + 0) as *mut u8) = (2i32) as u8;
                                        ...
                                        let super::super::super::timeline::core::api::Server{ worker_id:worker_id12, template_id:template_id12, } = server11;
                                        let vec13 = worker_id12;
                                        let ptr13 = vec13.as_ptr() as i32;
                                        let len13 = vec13.len() as i32;
                                        *((base + 12) as *mut i32) = len13;
                                      ...
                                      V41::TlHasExisted(e) => {
                                        ...
                                        *((base + 40) as *mut u8) = (op17.clone() as i32) as u8;
                                        let super::super::super::timeline::core::api::Server{ worker_id:worker_id21, template_id:template_id21, } = server16;
                                        let vec22 = worker_id21;
                                        let ptr22 = vec22.as_ptr() as i32;
                                        let len22 = vec22.len() as i32;
                                        *((base + 52) as *mut i32) = len22;
                                      ...
                                      V41::TlHasExistedWithin(e) => {
                                        ...
                                        *((base + 40) as *mut u8) = (op26.clone() as i32) as u8;
                                        let super::super::super::timeline::core::api::Server{ worker_id:worker_id30, template_id:template_id30, } = server25;
                                        let vec31 = worker_id30;
                                        let ptr31 = vec31.as_ptr() as i32;
                                        let len31 = vec31.len() as i32;
                                        *((base + 52) as *mut i32) = len31;
                                      ...
                                      V41::TlDurationWhere(e) => {
                                        *((base + 0) as *mut u8) = (5i32) as u8;
                                        ...
                                        let super::super::super::timeline::core::api::Server{ worker_id:worker_id34, template_id:template_id34, } = server33;
                                        let vec35 = worker_id34;
                                        let ptr35 = vec35.as_ptr() as i32;
                                        let len35 = vec35.len() as i32;
                                        *((base + 12) as *mut i32) = len35;
                                      ...
                                      V41::TlDurationInCurState(e) => {
                                        *((base + 0) as *mut u8) = (6i32) as u8;
                                        ...
                                        let super::super::super::timeline::core::api::Server{ worker_id:worker_id38, template_id:template_id38, } = server37;
                                        let vec39 = worker_id38;
                                        let ptr39 = vec39.as_ptr() as i32;
                                        let len39 = vec39.len() as i32;
                                        *((base + 12) as *mut i32) = len39;
