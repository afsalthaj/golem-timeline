                                  ...
                                  let base = result42 as i32 + (i as i32) * 72;
                                  {
                                    ...
                                    match e {
                                      ...
                                      V41::TlHasExisted(e) => {
                                        ...
                                        *((base + 8) as *mut i32) = wit_bindgen::rt::as_i32(timeline16);
                                        let super::super::super::timeline::core::api::EventPredicate{ col_name:col_name17, value:value17, op:op17, } = event_predicate16;
                                        let vec18 = col_name17;
                                        let ptr18 = vec18.as_ptr() as i32;
                                        let len18 = vec18.len() as i32;
                                        *((base + 20) as *mut i32) = len18;
                                      ...
                                      V41::TlHasExistedWithin(e) => {
                                        ...
                                        *((base + 8) as *mut i32) = wit_bindgen::rt::as_i32(timeline25);
                                        let super::super::super::timeline::core::api::EventPredicate{ col_name:col_name26, value:value26, op:op26, } = event_predicate25;
                                        let vec27 = col_name26;
                                        let ptr27 = vec27.as_ptr() as i32;
                                        let len27 = vec27.len() as i32;
                                        *((base + 20) as *mut i32) = len27;
