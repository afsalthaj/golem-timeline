                ...
                impl Api {
                  ...
                  pub fn initialize_timeline(&self,timeline: &TimelineOp,){
                    ...
                    unsafe {
                      ...
                      let layout26 = alloc::Layout::from_size_align_unchecked(vec26.len() * 48, 8);
                      ...
                      for (i, e) in vec26.into_iter().enumerate() {
                        let base = result26 as i32 + (i as i32) * 48;
                        {
                          use super::super::super::timeline::core::api::TimelineNode as V25;
                          match e {
                            V25::Leaf=> {
                              {
                                *((base + 0) as *mut u8) = (0i32) as u8;
                            ...
                            V25::Primitive(e) => {
                              *((base + 0) as *mut u8) = (1i32) as u8;
                              let super::super::super::timeline::core::api::PrimitiveTimeline{ op:op1, timeline:timeline1, value:value1, } = e;
                              *((base + 8) as *mut u8) = (op1.clone() as i32) as u8;
                              *((base + 12) as *mut i32) = wit_bindgen::rt::as_i32(timeline1);
                              use super::super::super::timeline::raw_events::api::EventValue as V3;
                              match value1 {
                            ...
                            V25::TlHasExisted(e) => {
                              *((base + 0) as *mut u8) = (3i32) as u8;
                              let super::super::super::timeline::core::api::FilteredTimeline{ filter:filter4, node:node4, event_predicate:event_predicate4, } = e;
                              *((base + 8) as *mut u8) = (filter4.clone() as i32) as u8;
                              *((base + 12) as *mut i32) = wit_bindgen::rt::as_i32(node4);
                              let super::super::super::timeline::core::api::EventColumnPredicateInfo{ col_name:col_name5, value:value5, } = event_predicate4;
                              let vec6 = col_name5;
                              let ptr6 = vec6.as_ptr() as i32;
                              let len6 = vec6.len() as i32;
                              *((base + 20) as *mut i32) = len6;
                            ...
                            V25::TlHasExistedWithin(e) => {
                              *((base + 0) as *mut u8) = (4i32) as u8;
                              let super::super::super::timeline::core::api::FilteredTimelineWithin{ filtered:filtered9, time:time9, } = e;
                              let super::super::super::timeline::core::api::FilteredTimeline{ filter:filter10, node:node10, event_predicate:event_predicate10, } = filtered9;
                              *((base + 8) as *mut u8) = (filter10.clone() as i32) as u8;
                              *((base + 12) as *mut i32) = wit_bindgen::rt::as_i32(node10);
                              let super::super::super::timeline::core::api::EventColumnPredicateInfo{ col_name:col_name11, value:value11, } = event_predicate10;
                              let vec12 = col_name11;
                              let ptr12 = vec12.as_ptr() as i32;
                              let len12 = vec12.len() as i32;
                              *((base + 20) as *mut i32) = len12;
                            ...
                            V25::TlDurationWhere(e) => {
                              *((base + 0) as *mut u8) = (5i32) as u8;
                              let super::super::super::timeline::core::api::FilteredTimeline{ filter:filter15, node:node15, event_predicate:event_predicate15, } = e;
                              *((base + 8) as *mut u8) = (filter15.clone() as i32) as u8;
                              *((base + 12) as *mut i32) = wit_bindgen::rt::as_i32(node15);
                              let super::super::super::timeline::core::api::EventColumnPredicateInfo{ col_name:col_name16, value:value16, } = event_predicate15;
                              let vec17 = col_name16;
                              let ptr17 = vec17.as_ptr() as i32;
                              let len17 = vec17.len() as i32;
                              *((base + 20) as *mut i32) = len17;
                            ...
                            V25::TlDurationInCurState(e) => {
                              *((base + 0) as *mut u8) = (6i32) as u8;
                              let super::super::super::timeline::core::api::FilteredTimeline{ filter:filter20, node:node20, event_predicate:event_predicate20, } = e;
                              *((base + 8) as *mut u8) = (filter20.clone() as i32) as u8;
                              *((base + 12) as *mut i32) = wit_bindgen::rt::as_i32(node20);
                              let super::super::super::timeline::core::api::EventColumnPredicateInfo{ col_name:col_name21, value:value21, } = event_predicate20;
                              let vec22 = col_name21;
                              let ptr22 = vec22.as_ptr() as i32;
                              let len22 = vec22.len() as i32;
                              *((base + 20) as *mut i32) = len22;
                      ...
                      wit_import((self).handle() as i32, result26 as i32, len26);
                      if layout26.size() != 0 {
