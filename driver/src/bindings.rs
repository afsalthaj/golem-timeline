            ...
            impl Api {
                ...
                ) -> Result<wit_bindgen::rt::string::String, wit_bindgen::rt::string::String>
                {
                    ...
                    unsafe {
                        ...
                        let layout42 =
                            alloc::Layout::from_size_align_unchecked(vec42.len() * 72, 8);
                            ...
                            let base = result42 as i32 + (i as i32) * 72;
                            {
                                ...
                                match e {
                                    V41::TimelineComparison(e) => {
                                        *((base + 0) as *mut u8) = (0i32) as u8;
                                        let super::super::super::timeline::core::api::TimelineConstantCompared{ op:op1, timeline:timeline1, value:value1, server:server1, } = e;
                                        *((base + 8) as *mut u8) = (op1.clone() as i32) as u8;
                                        *((base + 12) as *mut i32) =
                                            wit_bindgen::rt::as_i32(timeline1);
                                        use super::super::super::timeline::event_processor::api::EventValue as V3;
                                        match value1 {
                                            V3::StringValue(e) => {
                                                *((base + 16) as *mut u8) = (0i32) as u8;
                                        ...
                                        let super::super::super::timeline::core::api::Server {
                                            worker_id: worker_id4,
                                            template_id: template_id4,
                                        } = server1;
                                        let vec5 = worker_id4;
                                    ...
                                    V41::TimelineNegation(e) => {
                                        *((base + 0) as *mut u8) = (1i32) as u8;
                                        let super::super::super::timeline::core::api::TimelineNegated{ timeline:timeline7, server:server7, } = e;
                                        *((base + 8) as *mut i32) =
                                            wit_bindgen::rt::as_i32(timeline7);
                                        let super::super::super::timeline::core::api::Server {
                                            worker_id: worker_id8,
                                            template_id: template_id8,
                                        } = server7;
                                    ...
                                    V41::TlLatestEventToState(e) => {
                                        *((base + 0) as *mut u8) = (2i32) as u8;
                                        let super::super::super::timeline::core::api::ServerWithEventColumnName{ server:server11, event_column_name:event_column_name11, } = e;
                                        let super::super::super::timeline::core::api::Server {
                                            worker_id: worker_id12,
                                            template_id: template_id12,
                                        } = server11;
                                    ...
                                    V41::TlHasExisted(e) => {
                                        *((base + 0) as *mut u8) = (3i32) as u8;
                                        let super::super::super::timeline::core::api::TimelineWithEventPredicate{ timeline:timeline16, event_predicate:event_predicate16, server:server16, } = e;
                                        *((base + 8) as *mut i32) =
                                            wit_bindgen::rt::as_i32(timeline16);
                                        let super::super::super::timeline::event_processor::api::EventPredicate{ col_name:col_name17, value:value17, op:op17, } = event_predicate16;
                                        let vec18 = col_name17;
                                        let ptr18 = vec18.as_ptr() as i32;
                                        let len18 = vec18.len() as i32;
                                    ...
                                    V41::TlHasExistedWithin(e) => {
                                        *((base + 0) as *mut u8) = (4i32) as u8;
                                        let super::super::super::timeline::core::api::TimelineWithEventPredicateWithin{ filtered:filtered24, time:time24, } = e;
                                        let super::super::super::timeline::core::api::TimelineWithEventPredicate{ timeline:timeline25, event_predicate:event_predicate25, server:server25, } = filtered24;
                                        *((base + 8) as *mut i32) =
                                            wit_bindgen::rt::as_i32(timeline25);
                                        let super::super::super::timeline::event_processor::api::EventPredicate{ col_name:col_name26, value:value26, op:op26, } = event_predicate25;
                                        let vec27 = col_name26;
                                        let ptr27 = vec27.as_ptr() as i32;
                                        let len27 = vec27.len() as i32;
                        ...
                        match l44 {
                            ...
                            1 => {
                                let e = {
                                    let l48 = *((ptr43 + 4) as *const i32);
                                    let l49 = *((ptr43 + 8) as *const i32);
            ...
            pub mod api {
                ...
                const _: () = {
                    ...
                    unsafe extern "C" fn __export_run(
                        ...
                        let result3 = <_GuestImpl as Guest>::run(
                ...
                pub trait Guest {
                    fn run(
                        core_template_id: wit_bindgen::rt::string::String,
                        leaf_template_id: wit_bindgen::rt::string::String,
                        event_to_state_tempalte_id: wit_bindgen::rt::string::String,
                    ) -> Result<wit_bindgen::rt::string::String, wit_bindgen::rt::string::String>;
                }
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 3653] = [
    3, 0, 6, 100, 114, 105, 118, 101, 114, 0, 97, 115, 109, 13, 0, 1, 0, 7, 113, 1, 65, 2, 1, 66,
    3, 1, 106, 1, 115, 1, 115, 1, 64, 3, 16, 99, 111, 114, 101, 45, 116, 101, 109, 112, 108, 97,
    116, 101, 45, 105, 100, 115, 16, 108, 101, 97, 102, 45, 116, 101, 109, 112, 108, 97, 116, 101,
    45, 105, 100, 115, 26, 101, 118, 101, 110, 116, 45, 116, 111, 45, 115, 116, 97, 116, 101, 45,
    116, 101, 109, 112, 97, 108, 116, 101, 45, 105, 100, 115, 0, 0, 4, 0, 3, 114, 117, 110, 1, 1,
    4, 1, 19, 116, 105, 109, 101, 108, 105, 110, 101, 58, 100, 114, 105, 118, 101, 114, 47, 97,
    112, 105, 5, 0, 11, 9, 1, 0, 3, 97, 112, 105, 3, 0, 0, 7, 203, 26, 1, 65, 2, 1, 65, 29, 1, 66,
    29, 1, 122, 4, 0, 10, 110, 111, 100, 101, 45, 105, 110, 100, 101, 120, 3, 0, 0, 1, 114, 1, 5,
    118, 97, 108, 117, 101, 115, 4, 0, 3, 117, 114, 105, 3, 0, 2, 1, 112, 1, 1, 107, 1, 1, 111, 2,
    121, 5, 1, 112, 127, 1, 106, 1, 5, 1, 5, 1, 111, 2, 3, 119, 1, 113, 22, 12, 114, 101, 99, 111,
    114, 100, 45, 118, 97, 108, 117, 101, 1, 4, 0, 13, 118, 97, 114, 105, 97, 110, 116, 45, 118,
    97, 108, 117, 101, 1, 6, 0, 10, 101, 110, 117, 109, 45, 118, 97, 108, 117, 101, 1, 121, 0, 11,
    102, 108, 97, 103, 115, 45, 118, 97, 108, 117, 101, 1, 7, 0, 11, 116, 117, 112, 108, 101, 45,
    118, 97, 108, 117, 101, 1, 4, 0, 10, 108, 105, 115, 116, 45, 118, 97, 108, 117, 101, 1, 4, 0,
    12, 111, 112, 116, 105, 111, 110, 45, 118, 97, 108, 117, 101, 1, 5, 0, 12, 114, 101, 115, 117,
    108, 116, 45, 118, 97, 108, 117, 101, 1, 8, 0, 7, 112, 114, 105, 109, 45, 117, 56, 1, 125, 0,
