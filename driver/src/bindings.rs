                          ...
                          impl Api {
                            ...
                            pub fn initialize_timeline(&self,timeline: &TimelineOp,) -> Result<wit_bindgen::rt::string::String,wit_bindgen::rt::string::String>{
                              ...
                              unsafe {
                                    ...
                                    match e {
                                      ...
                                      V39::TimelineComparison(e) => {
                                        ...
                                        *((base + 12) as *mut i32) = wit_bindgen::rt::as_i32(timeline4);
                                        ...
                                        let super::super::super::timeline::core::api::Server{ worker_id:worker_id7, template_id:template_id7, } = server4;
                                        let vec8 = worker_id7;
                                        let ptr8 = vec8.as_ptr() as i32;
                                        let len8 = vec8.len() as i32;
                                        *((base + 36) as *mut i32) = len8;
                                ...
                                wit_import((self).handle() as i32, result40 as i32, len40, ptr41);
                                let l42 = i32::from(*((ptr41 + 0) as *const u8));
                                if layout40.size() != 0 {
                                ...
                                match l42 {
                                  0 => {
                                    let e = {
                                      let l43 = *((ptr41 + 4) as *const i32);
                                      let l44 = *((ptr41 + 8) as *const i32);
                                  ...
                                  1 => {
                                    let e = {
                                      let l46 = *((ptr41 + 4) as *const i32);
                                      let l47 = *((ptr41 + 8) as *const i32);
