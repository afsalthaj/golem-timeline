                          ...
                          impl Api {
                            ...
                            pub fn initialize_and(&self,child_worker1: &TypedTimelineResultWorker,child_worker2: &TypedTimelineResultWorker,) -> Result<wit_bindgen::rt::string::String,wit_bindgen::rt::string::String>{
                              ...
                              unsafe {
                                ...
                                let ptr78 = ret_area.as_mut_ptr() as i32;
                                #[cfg(target_arch = "wasm32")]
                                #[link(wasm_import_module = "timeline:timeline-processor-stub/stub-timeline-processor")]
                                extern "C" {
                                ...
                                wit_import((self).handle() as i32, result38_0, result38_1, result38_2, result38_3, result38_4, result38_5, result77_0, result77_1, result77_2, result77_3, result77_4, result77_5, ptr78);
                                let l79 = i32::from(*((ptr78 + 0) as *const u8));
                                match l79 {
                                  0 => {
                                    let e = {
                                      let l80 = *((ptr78 + 4) as *const i32);
                                      let l81 = *((ptr78 + 8) as *const i32);
                                  ...
                                  1 => {
                                    let e = {
                                      let l83 = *((ptr78 + 4) as *const i32);
                                      let l84 = *((ptr78 + 8) as *const i32);
                          ...
                          impl Api {
                            ...
                            pub fn initialize_not(&self,child_worker: &TypedTimelineResultWorker,) -> Result<wit_bindgen::rt::string::String,wit_bindgen::rt::string::String>{
                              ...
                              unsafe {
                                ...
                                wit_import((self).handle() as i32, result38_0, result38_1, result38_2, result38_3, result38_4, result38_5, ptr39);
                                let l40 = i32::from(*((ptr39 + 0) as *const u8));
                                match l40 {
                                  0 => {
                                    let e = {
