                    ...
                    pub mod timeline {
                      ...
                      pub mod event_processor_stub {
                        ...
                        pub mod stub_event_processor {
                          ...
                          impl Api {
                            #[allow(unused_unsafe, clippy::all)]
                            pub fn initialize(&self,worker: &WorkerId,) -> Result<wit_bindgen::rt::string::String,wit_bindgen::rt::string::String>{
                              ...
                              unsafe {
                                ...
                                wit_import((self).handle() as i32, ptr1, len1, ptr2);
                                let l3 = i32::from(*((ptr2 + 0) as *const u8));
                                match l3 {
                                  0 => {
                                    let e = {
                          ...
                          impl Api {
                            #[allow(unused_unsafe, clippy::all)]
                            pub fn latest_event_to_state(&self,event: &Event,) -> Result<wit_bindgen::rt::string::String,wit_bindgen::rt::string::String>{
                          ...
                          pub mod api {
                            ...
                            const _: () = {
                              ...
                              unsafe extern "C" fn __export_initialize_timeline(arg0: i32,arg1: i32,) -> i32 {
                                  ...
                                  let e84 = {
                                    ...
                                    let v83 = match l0 {
                                      ...
                                      1 => {
                                        let e83 = {
                                          ...
                                          TimelineConstantCompared{
                                            op: TimelineConstantComparator::_lift(l7 as u8),
                                            timeline: l8,
                                            value: v16,
                                            server: Server{
                                        ...
                                        TimelineNode::TimelineComparison(e83)
                                      }
                                      2 => {
                                        let e83 = {
                                        ...
                                        TimelineNode::TimelineNegation(e83)
                                      }
                                      3 => {
                                        let e83 = {
                                          ...
                                          TimelineWithEventPredicate{
                                            ...
                                            event_predicate: EventPredicate{
                                              ...
                                              value: v41,
                                              op: EventPredicateOp::_lift(l42 as u8),
                                            },
                                            server: Server{
                                      ...
                                      4 => {
                                          ...
                                          TimelineWithEventPredicateWithin{
                                            filtered: TimelineWithEventPredicate{
                                              ...
                                              event_predicate: EventPredicate{
                                                ...
                                                value: v60,
                                                op: EventPredicateOp::_lift(l61 as u8),
                                              },
                                              server: Server{
                                        ...
                                        TimelineNode::TlHasExistedWithin(e83)
                                      }
                                      5 => {
                                        let e83 = {
                                        ...
                                        TimelineNode::TlDurationWhere(e83)
                                      }
                                      n => {
                                        ...
                                        TimelineNode::TlDurationInCurState(e83)
                                      }
                                    };
                                ...
                                let result85 = <_GuestImpl as Guest>::initialize_timeline(TimelineOp{
                                  nodes: result84,
                                });
