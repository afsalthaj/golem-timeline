    ...
    pub mod timeline {
        pub mod event_processor_stub {
            ...
            pub mod stub_event_processor {
                ...
                pub type LatestEventToStateResult = super::super::super::super::timeline::event_processor::api::LatestEventToStateResult;
                ...
                const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_initialize_latest_event_state(
                        arg0: i32,
                        arg1: i32,
                        arg2: i32,
                        arg3: i32,
                        ...
                        let result2 = <_ApiImpl as GuestApi>::initialize_latest_event_state(
                    ...
                    const _: () = {
                        #[doc(hidden)]
                        #[export_name = "cabi_post_timeline:event-processor-stub/stub-event-processor#[method]api.initialize-latest-event-state"]
                        #[allow(non_snake_case)]
                        unsafe extern "C" fn __post_return_method_api_initialize_latest_event_state(
                            arg0: i32,
                        ) {
                ...
                const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_initialize_tl_has_existed(
                        arg0: i32,
                        arg1: i32,
                        arg2: i32,
                        arg3: i32,
                        ...
                        let result4 = <_ApiImpl as GuestApi>::initialize_tl_has_existed(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), super::super::super::super::timeline::event_processor::api::WorkerId{
                                  name: wit_bindgen::rt::string_lift(bytes0),
                                }, super::super::super::super::timeline::event_processor::api::EventPredicate{
                                  col_name: wit_bindgen::rt::string_lift(bytes1),
                                  value: v3,
                                  op: super::super::super::super::timeline::event_processor::api::EventPredicateOp::_lift(arg8 as u8),
                                });
                    ...
                    const _: () = {
                        #[doc(hidden)]
                        #[export_name = "cabi_post_timeline:event-processor-stub/stub-event-processor#[method]api.initialize-tl-has-existed"]
                        #[allow(non_snake_case)]
                        unsafe extern "C" fn __post_return_method_api_initialize_tl_has_existed(
                            arg0: i32,
                        ) {
                            let l0 = i32::from(*((arg0 + 0) as *const u8));
                            match l0 {
                ...
                const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_add_event(
                        arg0: i32,
                        arg1: i64,
                        arg2: i32,
                        arg3: i32,
                        ...
                        let result12 = <_ApiImpl as GuestApi>::add_event(
                            wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize),
                    ...
                    const _: () = {
                        #[doc(hidden)]
                        #[export_name = "cabi_post_timeline:event-processor-stub/stub-event-processor#[method]api.add-event"]
                        #[allow(non_snake_case)]
                        unsafe extern "C" fn __post_return_method_api_add_event(arg0: i32) {
                            let l0 = i32::from(*((arg0 + 0) as *const u8));
                            match l0 {
                                0 => {
                                    let l1 = *((arg0 + 4) as *const i32);
                ...
                const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_latest_event_to_state(
                        arg0: i32,
                        arg1: i64,
                    ) -> i32 {
                        #[allow(unused_imports)]
                        ...
                        let result0 = <_ApiImpl as GuestApi>::latest_event_to_state(
                            wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize),
                            arg1 as u64,
                        );
                        ...
                        match result0 {
                            Ok(e) => {
                                *((ptr1 + 0) as *mut u8) = (0i32) as u8;
                                let super::super::super::super::timeline::event_processor::api::LatestEventToStateResult{ event_col_name:event_col_name2, event_results:event_results2, } = e;
                                ...
                                *((ptr1 + 4) as *mut i32) = ptr3;
                                let vec8 = event_results2;
                                let len8 = vec8.len() as i32;
                                let layout8 =
                                    alloc::Layout::from_size_align_unchecked(vec8.len() * 32, 8);
                                ...
                                for (i, e) in vec8.into_iter().enumerate() {
                                    ...
                                    {
                                        let super::super::super::super::timeline::event_processor::api::EventStateResult{ time_period:time_period4, value:value4, } = e;
                                        let super::super::super::super::timeline::event_processor::api::TimePeriod{ t1:t15, t2:t25, } = time_period4;
                                        *((base + 0) as *mut i64) = wit_bindgen::rt::as_i64(t15);
                                        *((base + 8) as *mut i64) = wit_bindgen::rt::as_i64(t25);
                                        use super::super::super::super::timeline::event_processor::api::EventValue as V7;
                                        match value4 {
                                            V7::StringValue(e) => {
                            ...
                            Err(e) => {
                                ...
                                *((ptr1 + 8) as *mut i32) = len9;
                                *((ptr1 + 4) as *mut i32) = ptr9;
                            }
                        };
                        ptr1
                    }
                    ...
                    const _: () = {
                        #[doc(hidden)]
                        #[export_name = "cabi_post_timeline:event-processor-stub/stub-event-processor#[method]api.latest-event-to-state"]
                        #[allow(non_snake_case)]
                        unsafe extern "C" fn __post_return_method_api_latest_event_to_state(
                            arg0: i32,
                        ) {
                            let l0 = i32::from(*((arg0 + 0) as *const u8));
                            match l0 {
                ...
                const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_tl_has_existed(
                        arg0: i32,
                        arg1: i64,
                    ) -> i32 {
                        #[allow(unused_imports)]
                        ...
                        let result0 = <_ApiImpl as GuestApi>::tl_has_existed(
                            wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize),
                            arg1 as u64,
                        );
                        let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                    ...
                    const _: () = {
                        #[doc(hidden)]
                        #[export_name = "cabi_post_timeline:event-processor-stub/stub-event-processor#[method]api.tl-has-existed"]
                        #[allow(non_snake_case)]
                        unsafe extern "C" fn __post_return_method_api_tl_has_existed(arg0: i32) {
                            let l0 = i32::from(*((arg0 + 0) as *const u8));
                            match l0 {
                                0 => (),
                                _ => {
                ...
                pub trait GuestApi {
                    ...
                    fn tl_has_existed(
                        &self,
                        t1: u64,
                    ) -> Result<bool, wit_bindgen::rt::string::String>;
                }
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 4239] = [
    3, 0, 29, 119, 97, 115, 109, 45, 114, 112, 99, 45, 115, 116, 117, 98, 45, 101, 118, 101, 110,
    116, 45, 112, 114, 111, 99, 101, 115, 115, 111, 114, 0, 97, 115, 109, 13, 0, 1, 0, 7, 228, 13,
    1, 65, 15, 1, 66, 18, 1, 122, 4, 0, 10, 110, 111, 100, 101, 45, 105, 110, 100, 101, 120, 3, 0,
    ...
    101, 115, 64, 48, 46, 49, 46, 48, 5, 0, 1, 66, 19, 1, 113, 4, 12, 115, 116, 114, 105, 110, 103,
    ...
    105, 99, 97, 116, 101, 3, 0, 17, 3, 1, 28, 116, 105, 109, 101, 108, 105, 110, 101, 58, 101,
    118, 101, 110, 116, 45, 112, 114, 111, 99, 101, 115, 115, 111, 114, 47, 97, 112, 105, 5, 1, 2,
    3, 0, 0, 3, 117, 114, 105, 2, 3, 0, 1, 11, 101, 118, 101, 110, 116, 45, 118, 97, 108, 117, 101,
    2, 3, 0, 1, 5, 101, 118, 101, 110, 116, 2, 3, 0, 1, 9, 119, 111, 114, 107, 101, 114, 45, 105,
    100, 2, 3, 0, 1, 11, 116, 105, 109, 101, 45, 112, 101, 114, 105, 111, 100, 2, 3, 0, 1, 18, 101,
    118, 101, 110, 116, 45, 115, 116, 97, 116, 101, 45, 114, 101, 115, 117, 108, 116, 2, 3, 0, 1,
    28, 108, 97, 116, 101, 115, 116, 45, 101, 118, 101, 110, 116, 45, 116, 111, 45, 115, 116, 97,
